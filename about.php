...
<div class="container-fluid marqueebody" style="margin-top:109px;">
  ...
  <section id="overview">
    <div class="container mt-5">
        <div class="row">
          <div class="col-md-6 ">
            <h2 class=" text-danger" id="About" > 〣 Overview 〣</h2>
        <hr class="mt-2 mb-5 text-danger">
          ...
          <div class="col-md-6 ">
            ...
            <ul class=" fade-in" style="list-style-type: none;">
                ...
                <li><i class="fas fa-check-square"></i> Elastic and Vibrant Curriculum</li>
                <li><i class="fas fa-check-square"></i> Fully equipped Science and Computer Labs</li>
                <li><i class="fas fa-check-square"></i> Experiential Learning Opportunities</li>
                <li><i class="fas fa-check-square"></i> Special Performing Arts Programs</li>
                <li><i class="fas fa-check-square"></i> Field Trips and Sports Activities</li>
                <li><i class="fas fa-check-square"></i> Hygienic and Safe Learning Environment</li>
                <li><i class="fas fa-check-square"></i> Extra Eye - Parent Observers in the Classroom</li>
              </ul>
            </ul>
          </div>
        </div>
            ...
            <p class="fade-in akaya-kanadaka-regular">At Super School, we go beyond traditional education by offering innovative programs and hands-on learning experiences. Our dedicated faculty members are committed to nurturing each student's unique talents and helping them unlock their full potential.</p>
                ...
                <div class="container" style="margin-top: 15%;">
                    <div class="section-title justify-content-center mb-4 mb-md-8 " >
                        ...
                        <h2 class="fade-in text-danger" id="About" > 〣Leadership 〣</h2>
            <hr class="mt-2 mb-5 text-danger">
                    </div>
                            ...
                            <div class="card bg-light  mycard">
                                ...
                                <div class="card-body border-top-5 px-3 border-warning ">
                                    <h3 class="card-title fade-in ">
                                        <a class="text-warning  text-decoration-none text-capitalize d-block text-truncate" href="#">Mr. Raju Sangani</a>
                                    </h3>
                                    <p class="fade-in text-truncate" >Chairman</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3 col-xs-12">
                            <div class="card bg-light  mycard">
                                ...
                                <div class="card-body border-top-5 px-3  border-success">
                                    <h3 class="card-title fade-in ">
                                        <a class="text-success text-decoration-none text-capitalize d-block text-truncate" href="#">Mr. Vijaya</a>
                                    </h3>
                        ...
                        <div class="col-sm-6 col-lg-3 col-xs-12">
                            <div class="card bg-light mycard">
                                ...
                                <div class="card-body border-top-5 px-3 border-danger">
                                    <h3 class="card-title fade-in ">
                                        <a class="text-danger  text-decoration-none text-capitalize d-block text-truncate" href="#">Mr. Rajithkumar </a>
                                    </h3>
                                    <p class="fade-in text-truncate" >
